...
const OfferedApps = ({offered}) => {
  ...
  return (
      ...
      <div className="flex flex-row flex-wrap justify-between mx-5">
        <h1 className="text-lg">برنامه های پیشنهادی برای شما</h1>
        <Link href="/all"><p title="برنامه های پیشنهادی برای شما" className="cursor-pointer hover:text-green-600 text-sm mt-1">بیشتر<p className='inline mr-2 pt-1'>&#10095;</p></p></Link>
      </div>
      <Swiper
      modules={[Navigation]}
      spaceBetween={20}
